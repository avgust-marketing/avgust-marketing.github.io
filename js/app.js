...
// Color Switch End
// Avatar card //
const { createApp, defineComponent, ref, computed, onMounted } = Vue;
...
const Card = defineComponent({
  ...
  setup(props) {
    ...
    const cardBgImage = computed(() => {
      return `background-image: url(${props.dataImage});`;
    });
  ...
  template: `
    <div class="card-wrap"
      ...
      <div class="card" :style="cardStyle">
        <div class="card-bg" :style="[cardBgTransform, cardBgImage].join('')"></div>
        <div class="card-info">
          <slot></slot>
        </div>
      </div>
...
// Монтируем Vue-приложение, если нужно
createApp({
  components: {
    Card
  }
